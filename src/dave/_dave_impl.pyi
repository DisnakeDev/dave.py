...
class Session:
    ...
    def get_last_epoch_authenticator(self) -> bytes | None: ...
    ...
    def get_marshalled_key_package(self) -> bytes | None: ...

    def get_key_ratchet(self, user_id: str) -> IKeyRatchet | None: ...

    def get_pairwise_fingerprint(self, version: int, user_id: str) -> asyncio.Future[bytes | None]: ...
